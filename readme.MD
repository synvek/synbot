...
- **Desktop app**: Native Tauri application bundles synbot and the Admin Dashboard — see [Desktop App](docs/getting-started/desktop-app.md)
...
See [docs/getting-started/desktop-app.md](docs/getting-started/desktop-app.md) for details.
...
For more options see the [documentation](https://github.com/synvek/synbot/tree/main/docs).
...
Optional field `toolNamePrefix` (e.g. `"mcp_fs_"`) prefixes tool names to avoid clashes with built-in tools. Per-server `env` (stdio), `headers` (SSE), and `timeoutSecs` (default 30) are supported; see the [tools guide](docs/user-guide/tools.md#mcp-model-context-protocol).
